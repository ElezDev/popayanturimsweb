<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('comentarios',$CalifiArray['comentarios'],['class' => 'form-control' . ($errors->has('comentarios') ? ' is-invalid' : ''), 'placeholder' => 'Comentarios']) }}
            {!! $errors->first('comentarios', '<div class="invalid-feedback">:message</div>') !!}
        </div>

        <div class="form-group">
            {{ Form::label('reseñas') }}
            {{ Form::text('reseñas',$CalifiArray['reseñas'],['class' => 'form-control' . ($errors->has('reseñas') ? ' is-invalid' : ''), 'placeholder' => 'Reseñas']) }}
