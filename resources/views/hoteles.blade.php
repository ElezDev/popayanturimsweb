...
@section('content')
    ...
    <div class="bag_hotel" id="container_all">
        <div class="overlay">
            <div class="showcase-row-txt">
                ...
                <h1 id="txt-principal"> <span class="txt-secondary">Hoteles</span></h1>
    ...
    {{-- cartas carosel Puntos esenciales en Popayán  --}}
    <main>
        ...
        {{-- cartas carosel Puntos esenciales en Popayán   fin --}}
                   ...
                   ">
                            <div class="p-4">
                                <div class="d-flex justify-content-between mb-3">
                                    <small class="m-0"><i
                                            class="fa fa-map-marker-alt text-primary mr-2"></i>{{ $lugars['descripcion'] }} </small>
                                    <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>
                                        {{ $lugars['horarios'] }}</small>
                                    <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>{{ $lugars['direccion'] }}</small>
                                </div>
                                <a class="h5 text-decoration-none" href="">{{ $lugars['nombre'] }}</a>
